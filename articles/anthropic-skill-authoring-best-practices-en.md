---
title: Skill Authoring Best Practices (Anthropic Claude)
source: https://github.com/obra/superpowers/blob/main/skills/writing-skills/anthropic-best-practices.md
tags: [skill-authoring, best-practices, claude, prompt-engineering, ai-tools]
created: 2026-05-26
language: english
---
...
The instruction file (e.g., forms.md) references the script, and Claude can execute it without loading its contents into context.
...
In this example, you'd need to write the `pdf_to_images.py` script. Claude's vision capabilities help understand layouts and structures.
